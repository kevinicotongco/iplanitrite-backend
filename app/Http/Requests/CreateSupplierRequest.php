...
class CreateSupplierRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'supplierStaff' => ['required', 'array'],
            'supplierStaff.email' => ['required', 'email', 'unique:supplier_staff,email', 'max:255'],
            'supplierStaff.firstName' => ['required', 'string', 'max:255'],
            'supplierStaff.middleName' => ['nullable', 'string', 'max:255'],
            'supplierStaff.lastName' => ['required', 'string', 'max:255'],
        ];
    }
}
